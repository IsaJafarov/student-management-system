                    ...
                    <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true"
                        ...
                        <li class="nav-item active open">
                            <a href="all_students.html" class="nav-link nav-toggle"><i class="material-icons">group</i>
                                <span class="title">T?l?b?l?r</span><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li class="nav-item active open">
                                    <a href="all_students.html" class="nav-link "> <span class="title">Bütün t?l?b?l?r </span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="add_student.html" class="nav-link "> <span class="title">T?l?b? ?lav? et</span>
                                    </a>
                                </li>
                                <!-- <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="edit_student.html" class="nav-link "> <span class="title">T?nziml?</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="student_profile.html" class="nav-link "> <span class="title">T?l?b? haqqinda</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">Bütün t?l?b?l?r</div>
                        </div>
