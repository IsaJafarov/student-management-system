...
<div class="limiter">
    <div class="container-login100 page-background">
        <div class="wrap-login100">
            <form   class="login100-form validate-form" action="checkCode" method="post">
                ...
                <div class="wrap-input100 validate-input" data-validate="Enter username">
                    <input class="input100" type="number" name="writtenCode" placeholder="Emailinize gelen kodu daxil edin">
                    <span class="focus-input100" data-placeholder="&#xf207;"></span>
                </div>

                <p id ="error">
                    ${requestScope.get("incorrectCode")}
                </p>
